...
class CanonicalRowBuilderTest {
    ...
    private static final ClientConfig JPMC = new ClientConfig("jpmc", "yyyy-MM-dd", java.util.Map.of(), java.util.Map.of());
    private static final ClientConfig PIMCO = new ClientConfig("pimco", "MM/dd/yyyy", java.util.Map.of(), java.util.Map.of());
